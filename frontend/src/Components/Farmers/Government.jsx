...
const Government = () => (
  <>
    ...
    <header id="header" className="header py-2 text-center md:pt-2 lg:text-left xl:pt-2 xl:pb-2">
      ...
      <div className="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
        ...
        <div className="lg:col-span-5">
          <div className="xl:mt-12">
            <h2 className="mb-6">1. Instant results for the marketing department</h2>
    ...
    <div className="py-24">
      <div className="container px-4 sm:px-8 lg:grid lg:grid-cols-12 lg:gap-x-12">
        ...
        <div className="lg:col-span-5">
          <div className="xl:mt-12">
            <h2 className="mb-6">2. Instant results for the marketing department</h2>
            <ul className="list mb-7 space-y-2">
              <li className="flex">
                <i className="fas fa-chevron-right" />
                <div>Features that will help you and your marketers</div>
