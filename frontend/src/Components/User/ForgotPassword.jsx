...
const ForgotPassword = () => {
    ...
    return (
      ...
      <div className="flex flex-wrap justify-center items-center h-screen bg-white w-full overflow-y-scroll">
<div className="p-10">
  <form className="shadow-lg rounded-xl bg-white ring ring-black m:p-6 lg:px-40 lg:py-10 flex flex-col items-center" >
