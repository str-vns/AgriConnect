        ...
        <div className="mx-auto max-w-lg text-center border-2 p-10 border-black">
          <form onSubmit={submitHandler} encType="multipart/form-data">
            ...
            <div className="form-group">
              <label htmlFor="email_field" className="text-mg text-black text-left flex">
                Name
              </label>
              <input
                type="name"
            ...
            <div className="form-group">
              <label htmlFor="avatar_upload" className="text-mg text-black text-left flex">
                Avatar
              </label>
              <div className="d-flex align-items-center">
                ...
                <div className="custom-file">
                  ...
                  />
                  <label
                    className="custom-file-label float-left px-4 py-2 border-2 border-black rounded-md cursor-pointer bg-white text-black hover:bg-black hover:text-white"
                    htmlFor="customFile"
                  >
                    Choose Avatar
                  </label>
