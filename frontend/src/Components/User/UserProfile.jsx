  ...
  const getLocationFarmer = async () => {
    ...
    try {
      const { data } = await axios.get(
        `http://localhost:4000/api/v1/farmer/farmer/update`,
        config
      );
        ...
        <div className="bg-white rounded-lg shadow-xl pb-8">
          ...
          <div className="flex flex-col items-center -mt-20">
            {user.avatar && user.avatar.url ? (
              ...
              <div className="w-40 h-40 border-4 border-white rounded-full bg-gray-300 rounded-full">
                {/* Placeholder or default image when user.avatar.url is undefined or null */}
              </div>
            )}
            ...
            <p className="text-sm text-gray-500">Taguig,Philippines</p>
            <a href="/profile/update" className="text-gray-500 cursor-pointer">
              Edit
            </a>
          </div>
        </div>
            ...
            <div className="flex-1 bg-white rounded-lg shadow-xl p-8">
              ...
              <ul className="mt-2 text-gray-700">
                ...
                <li className="flex border-b py-2">
                  ...
                  <span className="text-gray-700">English, Tagalog</span>
                </li>
            ...
            <div className="w-full flex flex-col 2xl:w-1/3">
              <div className="flex-1 bg-white rounded-lg shadow-xl p-8">
                <h4 className="text-xl text-gray-900 font-bold">
                  Personal Farm Info Location
                </h4>
                <Link
                  to={`/farmerLocUpdate/${user._id}`}
                ...
                <ul className="mt-2 text-gray-700">
                  ...
                  <li className="flex border-b py-2">
                    ...
                    <span className="text-gray-700">
                      {farmer.address}, {farmer.city}, {farmer.postalCode}{" "}
                    </span>
                  </li>
                </ul>
              </div>
