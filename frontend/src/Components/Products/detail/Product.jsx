  ...
  />
          ...
          <div className="relative pt-3 bg-white">
            ...
            <Link to={`/product/${product._id}`} id="view_btn">
              <button className="ml-3 mt-2 border border-black inline-block px-4 py-2 text-sm font-medium text-gray-700 hover:bg-black hover:text-white focus:relative ">
                View Details
              </button>
            </Link>
          </div>
