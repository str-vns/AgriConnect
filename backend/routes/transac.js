...
const { newOrder, allOrders, updateOrderConfirmation, getOrderConfirmationFarmer, myOrders, getSingleOrder, upProcessOrder } = require('../controllers/transController');
