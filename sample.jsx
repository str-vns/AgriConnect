...
>
  <a href="#" className="flex items-center pb-4 border-b border-b-gray-800">
    <h2 className="font-bold text-2xl">
      AGRI{" "}
      <span className="bg-[#f84525] text-white px-2 rounded-md">CONNECT</span>
    </h2>
  </a>
  <ul className="mt-4">
...
{/* end sidenav */}
  <main className="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-200 min-h-screen transition-all main" style={{background: 'linear-gradient(rgb(221, 201, 98), rgba(255, 255, 255, 1))'}}>
    {/* Content */}
    <div className="p-6">
